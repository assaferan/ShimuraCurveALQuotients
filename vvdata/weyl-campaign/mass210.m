// Preregistration: mass-proportionality prediction for the 210_1 verdict.
// Support pair (7,1),(7,30) -- (210,1) is INDEFINITE (four primes), no Gross
// structure exists for it; at N=1 the third term must be realized otherwise.
// Predicts |w2/w1| = mass(7,30)/mass(7,1).
