// The 22_3 Gross-span test (allgross.m with base-4 data).
DEPTH := 200;
MMAX := DEPTH - 1;
R<q> := PowerSeriesRing(Rationals(), DEPTH);
DN := 66;
dsv := [1,2,3,4,6,11,12,22,33,44,66,132];
rs := [ [-3,6,-1,0,3,0,-2,0,0,0,0,0],
        [-2,1,4,0,2,0,-2,0,0,0,0,0],
        [-1,-1,1,3,4,0,-3,0,0,0,0,0],
        [0,-1,0,2,0,-2,0,4,0,0,0,0],
        [0,0,-1,0,2,-1,0,2,0,0,-1,2],
        [0,0,0,0,2,0,-1,2,2,-1,-1,0],
        [2,-1,0,0,0,0,0,4,0,-2,0,0] ];
cs := [ -1/10, -3/20, 3/10, -1, 6/5, -3/10, 1/4 ];
lev := 4*DN;
printf "BASE 22_3: DN = %o, level %o\n", DN, lev;
