// The 15_2 Gross-span test (allgross.m with base-4 data).
DEPTH := 200;
MMAX := DEPTH - 1;
R<q> := PowerSeriesRing(Rationals(), DEPTH);
DN := 30;
dsv := [1,2,3,4,5,6,10,12,15,20,30,60];
rs := [ [-3,7,0,-3,1,0,0,0,0,1,0,0],
        [-2,1,4,0,0,2,0,-2,0,0,0,0],
        [-1,0,0,4,-1,0,3,0,0,-2,0,0],
        [-1,2,0,0,-1,0,1,0,0,2,0,0],
        [-1,2,0,0,0,0,0,0,-3,0,7,-2],
        [0,0,0,2,0,0,0,-1,-2,-1,5,0] ];
cs := [ 2, -3, 4, -4, 2, 12 ];
lev := 4*DN;
printf "BASE 15_2: DN = %o, level %o\n", DN, lev;
