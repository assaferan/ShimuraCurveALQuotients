// The 33_1 Gross-span test (allgross.m with base-4 data).
DEPTH := 200;
MMAX := DEPTH - 1;
R<q> := PowerSeriesRing(Rationals(), DEPTH);
DN := 33;
dsv := [1,2,3,4,6,11,12,22,33,44,66,132];
rs := [ [0,-1,0,2,0,-2,0,4,0,0,0,0],
        [0,0,-2,0,5,-3,-2,6,1,0,-2,0],
        [0,0,-2,0,5,-2,-2,1,6,0,-3,0],
        [0,0,-2,0,5,0,-2,-3,0,6,1,-2] ];
cs := [ -12, 6, 3, -8 ];
lev := 4*DN;
printf "BASE 33_1: DN = %o, level %o\n", DN, lev;
