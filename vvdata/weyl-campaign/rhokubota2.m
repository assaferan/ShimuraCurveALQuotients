// Diagnostic for the even-c Stromberg edge: for EVERY word, measure the best
// global unit u (rv vs the Stromberg single-term sv), the residual deviation
// after dividing u out, and the matrix invariants a, c, d mod 8 / odd part of
// c -- the data a corrected even-c branch must be a function of.  Compare u
// against the Kubota cocycle sign as in rhokubota.m.
//
//   magma -b DD:=15 NN:=2 vvdata/weyl-campaign/rhokubota2.m
