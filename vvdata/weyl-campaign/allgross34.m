// The 34_3 fourth-base Gross-span test (allgross.m with base-4 data).
// Preregistered: support {(17,3),(17,6),(102,1)}, weights (-1, 3/2, -1/2).
DEPTH := 200;
MMAX := DEPTH - 1;
R<q> := PowerSeriesRing(Rationals(), DEPTH);
DN := 102;
dsv := [1,2,3,4,6,12,17,34,51,68,102,204];
rs := [ [0,0,-2,0,5,-2,-3,6,1,0,-2,0],
        [0,0,-2,0,5,-2,-2,1,6,0,-3,0],
        [0,0,-2,0,5,-2,0,-3,0,6,1,-2] ];
cs := [ 1, -3, 2 ];
lev := 4*DN;
printf "BASE 34_3: DN = %o, level %o\n", DN, lev;
