...
//      non-hyperelliptic;
//  (b) it is effective -- it proves many D=10 curves non-hyperelliptic, on both the base component
//      X_0(10,1) (W''={1}) and the intermediate quotients, at special-fiber primes well beyond the
//      D=6 hypergeometric range; and
//  (c) it settles X_0(10,71)/<w_10,w_71> (g=3), previously undetermined.
// Curves are the genuine pipeline records (X_0(10,p)/W with W'' the base or an intermediate quotient).
...
procedure test_SpecialFiberD10()
    ...
    // reachable W'' : base X_0(10,1), the three intermediate quotients, and the full star
    inter := {{Integers()|1},{Integers()|1,2},{Integers()|1,5},{Integers()|1,10},{Integers()|1,2,5,10}};
