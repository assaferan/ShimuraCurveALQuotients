...
// KNOWN-DRIFTED, recorded rather than asserted away. These three are unreproducible because the
// unpinned-y2-scale guard (1768517) postdates them; the committed models are correct but the
// current pipeline withholds covers they contain. Y2TWIST=1 is the candidate remedy. Update this
// list -- do not delete the check -- when they are regenerated or the guard is changed.
MR_KNOWN_DRIFT := ["22_3", "15_2", "22_5"];
