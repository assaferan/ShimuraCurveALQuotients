...
$X_0^{22}(5)$, $X_0^{38}(3)$, $X_0^{14}(3)$, $X_0^{6}(11)$, $X_0^{10}(11)$ and $X_0^{14}(5)$
have since been measured. Every one is consistent with the two-channel
form~\eqref{eq:twochannel}, with spare conditions; $X_0^{14}(5)$ \emph{pins}
$w_{\square}=0$, as predicted ($5\mid DN$ splits in $\Q(i)$). On the remaining seven the
nine-form panel leaves $w_{\square}$ undetermined: the square-class column of the
