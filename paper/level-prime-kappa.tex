...
(real, with sign $\mu(g/4)$); and at odd $g$ the phase is
$e(\theta_g)$ with $8\theta_g\equiv1+6\,r(g)+4\,s(g)\bmod 8$, where $r(g)=\#\{p\mid g:
p\equiv3\bmod4\}$ and $s(g)=\#\{p<q\mid g:(\tfrac pq)(\tfrac qp)=+1\}$ --- nine distinct
classes across the six bases, no exceptions. The pinned constants of the evaluation are
